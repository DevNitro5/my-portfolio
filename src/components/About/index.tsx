...
export function About() {
  return (
    <>
      <Wave />
      <footer className="bg-darkRed w-full flex items-center justify-center h-[15rem] px-7">
        <div className="lg:max-w-[50%] flex flex-col space-y-5 items-center justify-center">
